...
created: December 13, 2020 8:18 PM
tag: next.js, nextjs-jobs
date: 2020/11/18
description: A Next.js job board.
slug: next-js-jobs
...
**UPDATE**: While this project is paused, I suggest checking out the [Next.js Discord](https://discord.com/invite/KNKF84E) for current job opportunities.

~~This project is currently on hold. I'm looking into options on how to open source it soon.~~
...
The production level of this conference was _waay_ better than I was anticipating. The keynote,along with each of the individual presentations, showed a high level of polish while still feeling like a conference talk. I think this was accomplished by pre-recording talks, but requiring a “one-take” policy, meaning the video had to be recorded in one sitting with no edits.
...
But what I was impressed with was the **community**.

Tons of people registered, over 75k. And about half of them showed up!
...
And then after the conference, all of those extra job channels got cleaned up. That left me thinking, where are all these job posts going to go? I searched around, but there was no home for them.

Current job boards barely treat Next.js as a first class citizen, but rather emphasize React. That’s probably fine for most cases for the hiring mangers, as a good React dev can be taught Next.js.
...
![/images/nextjs-jobs.png](/images/nextjs-jobs.png)
...
~~There are _a lot_ of missing features right now, but rather than build them, I want to validate there is actually market demand here. So please test it out, let me know what you think!~~
...
If you want to keep up with all things Next.js, head over to my [newsletter](/newsletter).
